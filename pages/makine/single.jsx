                  ...
                  imagesData?.map((item, index) => (
                    <div key={index}>
                      <Image
                        ...
                        alt=""
                        preview={true}
                        className=' object-cover   object-to !w-full  !overlflow-hidden !h-[430px]  md:!h-[600px] '
                ...
                imagesData?.map((item , index) => (
                  <li key={index} onClick={() => slider(index)} className='g-c-p'>
                    <Image
                      ...
                      alt=""
                      preview={false}
                      className=' object-cover min-w-[100%] !w-full  !overlflow-hidden !h-[110px] md:!h-[175px] '
