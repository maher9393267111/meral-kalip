                  ...
                  imagesData?.map((item, index) => (
                    <div key={index}>
                      <Image
                        ...
                        alt=""
                        preview={true}
                        className=' object-cover object-center !w-full  !overlflow-hidden !h-[600px] md:!h-[1000px] '
                ...
                imagesData?.map((item , index) => (
                  <li key={index} onClick={() => slider(index)} className='g-c-p'>
                    <Image
                      ...
                      alt=""
                      preview={false}
                      className=' object-cover min-w-[100%] !w-full  !overlflow-hidden !h-[160px] md:!h-[220px] '
...
// <div
//   dir={dir}
//   className="mt-8 gap-3 flex lg:mt-0 lg:flex-shrink-0"
// >
//   {/* 
...
//   <div className="inline-flex rounded-md shadow">
//     <a
//       href="https://wtspee.com/905522982310"
//       target="_blank"
...
// <h1 dir={dir} className="text-5xl arabic font-bold  mt-12">
//   {router?.locale === "ar"
//     ? product?.titlear
//     : router.locale === "en"
//     ? product?.title
...
//     <article
//       dir={dir}
//       className="prose arabic text-xl max-w-none pb-6"
//     >
//       {router?.locale === "ar"
//         ? product?.descar
//         : router.locale === "en"
...
//       <div
//         dir={dir}
//         className="inline-fle rounded-md shado"
//       >
